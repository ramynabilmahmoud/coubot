...
class _RecommendationDialogState extends State<RecommendationDialog> {
  ...
  Future<void> _loadRecommendation() async {
    ...
    try {
      ...
      setState(() => _error = _localizeError(code));
    } finally {
      if (mounted) {
  ...
  String _localizeError(String code) {
    switch (code) {
      case kErrOutdatedCategoryField:
        return S.of(context).aiRecommendationOutdatedFunction;
      case kErrGeminiBusy:
        return S.of(context).aiBusyTryAgain;
      default:
        return code;
    }
  }
      ...
      child: SingleChildScrollView(
        child: Column(
          ...
          children: [
            ...
            Text(
              S.of(context).aiRecommendationUnavailable,
              ...
              children: [
                Row(
                  children: [
                    ...
                    Text(S.of(context).minutesShort(recommendation.estimatedTime)),
                  ],
                ),
                const SizedBox(height: 14),
                Text(
                  ...
                  children: [
                    Expanded(
                      child: OutlinedButton.icon(
                        ...
                        label: Text(S.of(context).tryAnother),
                      ),
                    ),
                    const SizedBox(width: 10),
                    Expanded(
