...
/// Stable error codes for known failure cases, mapped to localized text by
/// the UI layer (this service has no [BuildContext] to call `S.of(context)`).
const String kErrOutdatedCategoryField = 'ERR_OUTDATED_CATEGORY_FIELD';
const String kErrGeminiBusy = 'ERR_GEMINI_BUSY';
